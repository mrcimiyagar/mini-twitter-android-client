...
public class TrendingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.fragment_trending, container, false);

        postsRV = contentView.findViewById(R.id.fragment_trending_posts_recycler_view);
        refreshBtn = contentView.findViewById(R.id.fragment_trending_refresh_button);
    ...
    public void readTopTweetsFromServer() {

        RequestGetTopTweets requestGetTopTweets = new RequestGetTopTweets();

        MyApp.getInstance().getNetworkHelper().pushTCP(requestGetTopTweets, new OnRequestAnsweredListener() {
            @Override
            public void onRequestAnswered(BaseAnswer rawAnswer) {

                final AnswerGetTopTweets answerGetTopTweets = (AnswerGetTopTweets) rawAnswer;
                        ...
                        public void run() {
                            try {
                                postsRV.setAdapter(new TweetAdapter((AppCompatActivity) getActivity(),
                                        TrendingFragment.this, myId, -1, answerGetTopTweets.tweets));
